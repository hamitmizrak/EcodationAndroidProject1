...
public class TelephoneValidation2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //start codes
        //id almak
        phoneNumberEditTextId2 = findViewById(R.id.phoneNumberEditTextId);
        phoneCodeEditTextId2 = findViewById(R.id.phoneCodeEditTextId);
        confirmationButtonId2 = findViewById(R.id.confirmationButtonId);
        ...
        callBackData = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    if (snapshot.exists()) {
                                        ...
                                        Intent homePageActivityIndent = new Intent(getApplicationContext(), AdminActivity2.class);
                                ...
                                public void onCancelled(@NonNull DatabaseError error) {
                                    ...
                                    Toast.makeText(TelephoneValidation2.this, "Login Çıkış yapıldı", Toast.LENGTH_SHORT).show();
                                }//onCancelled
                            });
                        } //isSuccessful end
                    } //onCompleted end
            ...
            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                recognationId = s;
                confirmationButtonId2.setText("Onaylama Yapabilirsiniz");
                //onaylama sonrasında editText çalışssın
                phoneNumberEditTextId2.setVisibility(View.INVISIBLE);
                phoneCodeEditTextId2.setVisibility(View.VISIBLE);
            }//onCodeSent end
        }; //callBackData end

        //butona tıklandığında gerçekleşecek olay
        confirmationButtonId2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (recognationId != null) {
                    PhoneAuthCredential credential = PhoneAuthProvider.getCredential(recognationId, phoneCodeEditTextId2.getText().toString());
